...
from app.models import user, closet  # Ensure models are loaded before create_all
...
async def lifespan(app: FastAPI):
    try:
        ...
        # Ensure any missing columns on existing tables are safely added
...
def read_root():
    return {
        "status": "online",
        "message": "Welcome to FitCheck AI API",
        "docs": "/docs"
    }
